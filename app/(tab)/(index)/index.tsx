...
import { Platform, View, Text, TextInput, Button, Alert, StyleSheet, TouchableOpacity } from 'react-native';
        ...
        <GradientTheme>
            <View style={{ flex: 1, paddingTop: 100, paddingHorizontal: 15 }}>
                ...
                <View style={styles.mapBtnContainer}>
                    ...
                    <TouchableOpacity style={styles.mapBtn} onPress={() => router.push('/post')}>
                        <Text>+ ADD POST</Text>
                    </TouchableOpacity>
                </View>
